...
> 📦 **档案（2026-09-19 文档审计，基线 `6b2f038` / v0.22.0-hot.19）**：历史重设计定稿，已归档。
> **写于** 2026-09-09（设计定稿）｜ **被取代**：随 0.15.0 全量实施 ｜ **现状看** docs/ARCHITECTURE.md §7.1（目标模式 v2 现行语义）。


> 状态：设计定稿，随 0.18.0 目标模式阶段实施
> 前置阅读：`LOOP-ENGINEERING.md`（理念出处）、`CONSTRUCTION-PLAN.md` 阶段 7
