...
assert(rmPreset?.options?.reasoningLevel === 'high', '预设模型引用带注册时声明的 reasoningLevel')
...
assert(rmPresetUnknown?.modelId === 'gpt-x' && rmPresetUnknown?.options?.reasoningLevel === 'high', '目录外模型同样注册完整定义并带 level（union-alpha 场景）')
