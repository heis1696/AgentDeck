  ...
  const body = (
    <>
      <div className="runtime-content">
        ...
        <div className="runtime-summary"><div><span className="runtime-kpi">{healthy}</span><small>健康后端</small></div><div><span className="runtime-kpi">{snapshots.length - healthy}</span><small>需要关注</small></div><div><span className="runtime-kpi">{agents.length}</span><small>已配置 Agent</small></div></div>
